...
<body>
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-10">
				<form action="/customerService/QA/qaInsert" method="post" id="insert">
					...
					<div class="mb-3">
						...
						<input type="text" name="title" class="form-control" id="exampleFormControlInput2" placeholder="제목을 입력해주세요." required="required">
					</div>
					<div class="mb-3">
