	...
	<div class="mainContents">
		<div class="container">
			...
			<form action="/customerService/freeboard/search">
		    	<div class="navbar navbar-light bg-light LMRposition">
	        ...
	        <nav aria-label="Page navigation example" class="LMRposition">
	            ...
	            <ul class="pagination justify-content-center LMRpositionCenter">
				<c:if test="${pageMaker.startPage > pageMaker.pageBlock }">
					<a class="page-link" href="<%=context %>/customerService/freeboard/main?pageNum=${pageMaker.startPage-pageMaker.pageBlock }"  aria-label="Previous">
		        ...
		        <c:forEach var="num" begin="${pageMaker.startPage }" end="${pageMaker.endPage }">
		            <li class="page-item">
		            	<a class="page-link" href="<%=context %>/customerService/freeboard/main?pageNum=${num }">${num }</a>
					</li>
				</c:forEach>
				<c:if test="${pageMaker.endPage < pageMaker.totalPage }">
					<a class="page-link" href="<%=context %>/customerService/freeboard/main?pageNum=${pageMaker.startPage+pageMaker.pageBlock }" aria-label="Next">
						<span aria-hidden="true">&raquo;</span>
						<span class="sr-only">Next</span>
					</a>
				</c:if>
	            </ul>
				<a  href="/customerService/freeboard/write" class="LMRpositionRight">
