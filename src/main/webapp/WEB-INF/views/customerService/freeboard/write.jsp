...
<script type="text/javascript">
	...
	function submitChk(category){
		...
		if(category==""){
			...
			if(confirm("게시글을 등록하시겠습니까?")) return true;
			else return false;
		}
...
<div class="mainContents">
	<div class="container">
		...
		<a class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
			<span class="fs-5 fw-semibold">게시글작성</span>
		</a>
		<form action="/customerService/freeboard/write" method="post" id="contentForm" onsubmit="return submitChk(category.value)">
				<div class="mb-3">
				  	...
				  	<c:forEach var="category" items="${comm }">
				  		<c:choose>
					  		<c:when test="${category.mcd==999 }">
					  			<option value="" selected="selected" style="display: none;">카테고리를 선택해주세요.</option>
					  		</c:when>
				...
				<div class="buttons mb-3">
					...
					<div contenteditable="true" class="boardContentDiv form-control mb-3" id="boardContentDiv"></div>
